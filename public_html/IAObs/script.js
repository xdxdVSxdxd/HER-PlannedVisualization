...
function chart(column, filterBy, groupBy) {
  ...
  var height = $("body").height() - margin.top - margin.bottom;
  ...
  */
  ...
  d3.json("http://164.132.225.138/~hefotov/HEv3/api/getTopicTimeSeries?researches=120&mode=" + $("#tempo").find(":selected").val() + "&gt=" + $("#sens").find(":selected").val() + "", function(data) {
